...
ggsave(
  file.path(results_dir, "GSEA_Hallmark_IL6_JAK_STAT3.pdf"),
  plot = p_il6_jak,
  width = 7,
  height = 6
)
...
ggsave(
  file.path(results_dir, "GSEA_Hallmark_Inflammatory_Response.pdf"),
  plot = p_inflam,
  width = 7,
  height = 6
)
...
ggsave(
  file.path(results_dir, "GSEA_Hallmark_Allograft_Rejection.pdf"),
  plot = p_allograft,
  width = 7,
  height = 6
)
...
ggsave(
  file.path(results_dir, "GSEA_Hallmark_TNFA_NFKB.pdf"),
  plot = p_tnfa_nfkb,
  width = 7,
  height = 6
)
...
ggsave(
  file.path(results_dir, "GSEA_Hallmark_Apoptosis.pdf"),
  plot = p_apoptosis,
  width = 7,
  height = 6
)
...
ggsave(
  file.path(results_dir, "GSEA_Hallmark_IL2_STAT5.pdf"),
  plot = p_il2_stat5,
  width = 7,
  height = 6
)
...
ggsave(
  file.path(results_dir, "GSEA_Hallmark_Complement.pdf"),
  plot = p_complement,
  width = 7,
  height = 6
)
